...
import Credentials from "@/components/configuration/credentials/page";
...
import Record from "@/components/configuration/record/record";

import PersonnelPage from "../CollaboratorSettings/Presonnel";

interface Section {
  title: string;
  options: { label: string; component?: React.FC }[]; // Agregamos component opcional
}
...
const sections: Section[] = [
  ...
  },
  {
    ...
    options: [{ label: "Ajustes" }, { label: "Historial", component: Record }],
  },
  {
    title: "Colaboradores",
    options: [
